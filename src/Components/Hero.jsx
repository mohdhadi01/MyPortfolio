...
function Hero() {
    ...
    return (<>
        ...
        <div className="Socials mx-8 my-10 flex gap-6 justify-center">
            ...
            <a href="https://twitter.com/mohdhadi01"><img src={Twitter} className='SocialIcons' alt="" /></a>
        </div>
