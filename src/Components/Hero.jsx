...
function Hero() {
    ...
    return (<>
        ...
        <div name="home" className='Hero'>
            ...
            <div
                className="Image">
                <img loading='lazy' src={profileImg} className='myImage' alt="" />
            </div>

        </div>
        <div className="buttons">
            <a href="https://drive.google.com/file/d/1JD2K5xF108FjhZmcTlFYeoEPk69SN-va/view?usp=drive_link">
                <div
