  ...
  return (
    <>
      ...
      <div name="home" className="Hero">
        <div className="Desc">
          <h3
            className="gradientText helloText font-semibold text-lg my-1"
          ...
          <h2
            className="gradientText frontendDev text-5xl font-medium"
      ...
      <div className="Socials mx-8 my-10 flex gap-6 justify-center">
        ...
        >
          <svg
            ...
            stroke-width="0"
            viewBox="0 0 24 24"
            class="SocialIcons text-secondary hover:text-secondary/50  text-2xl md:text-3xl "
            height="1em"
            width="1em"
