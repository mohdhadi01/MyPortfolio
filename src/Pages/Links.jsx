      ...
      <div name="links" className="AboutPage pt-28">
        ...
        <div className="linkContainer">
          <div className="featuredLinks">
            ...
            <a href="/">
              <div className="LinkBox my-3 flex align-middle">
                <h3 className="MyProfile flex gap-2 font-semibold">
                  <UserSearchIcon /> mohdhadi
                </h3>{" "}
                <MoveUpRight className="linkArrow w-4 flex" />
              </div>
            </a>
            ...
            >
              <div className="LinkBox my-3 flex align-middle">
                <h3 className="Linkedin flex gap-2 font-semibold">
                  {" "}
                  <img className="LinkIconImg" src={CinematrixIcon} alt="" />{" "}
                  CinemaTrix
                </h3>
                <MoveUpRight className="linkArrow w-4 flex" />
              </div>
            ...
            >
              <div className="LinkBox my-3 flex align-middle">
                <h3 className="Linkedin flex gap-2 font-semibold">
                  <img className="LinkIconImg" src={NewsChronIcon} alt="" />
                  News-Chron
                </h3>
                <MoveUpRight className="linkArrow w-4 flex" />
              </div>
            ...
            >
              <div className="LinkBox my-3 flex align-middle">
                <h3 className="Linkedin flex gap-2 font-semibold">
                  <img className="LinkIconImg" src={LiveTransIcon} alt="" />
